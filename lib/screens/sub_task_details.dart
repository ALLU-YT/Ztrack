...
import 'package:ztrack/screens/sub_task_details_task.dart';
import 'package:ztrack/screens/task_details.dart';

class Sub_Task_Details extends StatefulWidget {
  const Sub_Task_Details({super.key});

  @override
  State<Sub_Task_Details> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<Sub_Task_Details> {
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => const Task_Details(),
              ));
            },
            icon: Image.asset(
